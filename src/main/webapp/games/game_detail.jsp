				...
				<section id="right">
					<section id="summary">
						...
						<section id="summary2">
							...
							<script>
								function gameStart() {
									window.open('/games/gameStart_Rumi.jsp', '_blank');
								}
							</script>
						</section>
						<div class="clear"></div>
					...
					<section id="explanation">
						<h3>게임 설명</h3>
						<div class="detail">
							<img src="/img/flashgame/ex1.jpg"> <img
								src="/img/flashgame/ex2.jfif"> <img
								src="/img/flashgame/ex3.jfif"> <img
								src="/img/flashgame/ex4.png"> <img
								src="/img/flashgame/ex5.png"> <img
								src="/img/flashgame/ex6.png">
						</div>
					</section>
				</section>
				<div class="clear"></div>
